  ...
  template: `
      ...
      <div class="max-w-6xl mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
          ...
          <div class="hidden md:flex items-center gap-8">
            <button (click)="navigateTo('/jobs')" class="text-navy-900 text-sm font-medium">Tööpakkumised</button>
    ...
    <div class="py-8 px-4 bg-gray-50 min-h-screen">
      <div class="max-w-6xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
          <h1 class="text-2xl font-bold text-navy-900 mb-1">Tööpakkumised</h1>
          <p class="text-gray-500 text-sm">{{ filteredJobs.length }} aktiivset pakkumist</p>
        </div>
        ...
        <div class="grid lg:grid-cols-4 gap-6">
              ...
              <div class="space-y-4">
                ...
                <div>
                  <label class="flex items-center gap-2 cursor-pointer">
                    ...
                    <span class="text-sm text-gray-700">Majutus tagatud</span>
                  </label>
                </div>
          ...
          <div class="lg:col-span-3">
            <div class="space-y-4">
              <div
                *ngFor="let job of filteredJobs"
                ...
                <div class="flex items-start justify-between gap-4 mb-3">
                  <div>
                    <div class="flex items-center gap-2 mb-1">
                      <h3 class="font-semibold text-navy-900">{{ getRoleLabel(job.roleType) }}</h3>
                      <span *ngIf="job.urgent" class="badge badge-amber">Kiire</span>
                    </div>
                ...
                <div class="flex items-center gap-4 text-xs">
                  <span *ngIf="job.accommodationProvided" class="flex items-center gap-1 text-green-600">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                    </svg>
                    Majutus
                  </span>
                  <span *ngIf="job.travelProvided" class="flex items-center gap-1 text-green-600">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                    </svg>
                    Reisikulud
              ...
              <div *ngIf="filteredJobs.length === 0" class="bg-white border border-gray-200 rounded-lg p-12 text-center">
